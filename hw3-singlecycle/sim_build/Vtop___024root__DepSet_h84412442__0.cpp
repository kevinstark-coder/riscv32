...
VL_INLINE_OPT void Vtop___024root___ico_sequent__TOP__0(Vtop___024root* vlSelf) {
            ...
            if ((1U & (~ ((IData)(vlSelf->RiscvProcessor__DOT__datapath__DOT__insn_opcode) 
                ...
                if ((8U & (IData)(vlSelf->RiscvProcessor__DOT__datapath__DOT__insn_opcode))) {
                    ...
                    if ((2U & (IData)(vlSelf->RiscvProcessor__DOT__datapath__DOT__insn_opcode))) {
                        if ((1U & (IData)(vlSelf->RiscvProcessor__DOT__datapath__DOT__insn_opcode))) {
                            vlSelf->RiscvProcessor__DOT__datapath__DOT__pcNext 
                                = (0xfffffffeU & (vlSelf->RiscvProcessor__DOT__datapath__DOT__rs1_data 
                                                  + vlSelf->RiscvProcessor__DOT__datapath__DOT__imm_i_sext));
                        }
                    }
                } else if ((2U & (IData)(vlSelf->RiscvProcessor__DOT__datapath__DOT__insn_opcode))) {
                    if ((1U & (IData)(vlSelf->RiscvProcessor__DOT__datapath__DOT__insn_opcode))) {
                        if (vlSelf->RiscvProcessor__DOT__datapath__DOT__insn_beq) {
                            if ((vlSelf->RiscvProcessor__DOT__datapath__DOT__rs1_data 
                                 == vlSelf->RiscvProcessor__DOT__datapath__DOT__rs2_data)) {
                                vlSelf->RiscvProcessor__DOT__datapath__DOT__pcNext 
                                    = (vlSelf->RiscvProcessor__DOT__datapath__DOT__pcCurrent 
                                       + vlSelf->RiscvProcessor__DOT__datapath__DOT__imm_b_sext);
                            ...
                            if (VL_LTS_III(32, vlSelf->RiscvProcessor__DOT__datapath__DOT__rs1_data, vlSelf->RiscvProcessor__DOT__datapath__DOT__rs2_data)) {
                                vlSelf->RiscvProcessor__DOT__datapath__DOT__pcNext 
                                    = (vlSelf->RiscvProcessor__DOT__datapath__DOT__pcCurrent 
                                       + vlSelf->RiscvProcessor__DOT__datapath__DOT__imm_b_sext);
                            }
                        } else if (vlSelf->RiscvProcessor__DOT__datapath__DOT__insn_bge) {
                            if (VL_GTES_III(32, vlSelf->RiscvProcessor__DOT__datapath__DOT__rs1_data, vlSelf->RiscvProcessor__DOT__datapath__DOT__rs2_data)) {
                                vlSelf->RiscvProcessor__DOT__datapath__DOT__pcNext 
                                    = (vlSelf->RiscvProcessor__DOT__datapath__DOT__pcCurrent 
                                       + vlSelf->RiscvProcessor__DOT__datapath__DOT__imm_b_sext);
                            }
    ...
    if (vlSymsp->_vm_contextp__->assertOn()) {
        if (VL_UNLIKELY((0U != (3U & vlSelf->RiscvProcessor__DOT__datapath__DOT__pc_to_imem)))) {
            VL_WRITEF("[%0t] %%Error: DatapathSingleCycle.sv:564: Assertion failed in %NRiscvProcessor.mem: 'assert' failed.\n",
                      64,VL_TIME_UNITED_Q(1000),-9,
                      vlSymsp->name());
            VL_STOP_MT("/home/penn/riscv32/hw3-singlecycle/DatapathSingleCycle.sv", 564, "");
        }
    }
    if (vlSymsp->_vm_contextp__->assertOn()) {
        if (VL_UNLIKELY((0U != (3U & vlSelf->RiscvProcessor__DOT__mem_data_addr)))) {
            VL_WRITEF("[%0t] %%Error: DatapathSingleCycle.sv:565: Assertion failed in %NRiscvProcessor.mem: 'assert' failed.\n",
                      64,VL_TIME_UNITED_Q(1000),-9,
                      vlSymsp->name());
            VL_STOP_MT("/home/penn/riscv32/hw3-singlecycle/DatapathSingleCycle.sv", 565, "");
        }
    }
...
void Vtop___024root___eval_triggers__act(Vtop___024root* vlSelf) {
    ...
    vlSelf->__VactTriggered.set(3U, ((~ (IData)(vlSelf->clock_proc)) 
                                     & (IData)(vlSelf->__Vtrigprevexpr___TOP__clock_proc__0)));
